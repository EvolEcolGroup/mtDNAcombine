...
#'
#' Function takes data frame with column $sci_nam and uses a .csv file containg
#' exisiting names and desired replacement names to standise species nomenclature
...
#' therefore not work unless names are standadised. This function reads in a .csv
...
#' is exisitng scientific name, second column is name to replace exisiting
#' character string with. Structure built on exported "pos_synonyms.csv" file.
#'
#' @export
