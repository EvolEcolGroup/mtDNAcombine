...
```{r echo=FALSE}
knitr::include_graphics(system.file("extdata", "/mtDNAcombine_flow.jpg", 
...
```{r align and summarise the sequence data, eval=FALSE}
...
info_df <- read.csv(system.file("extdata","Inf_df.csv", package="mtDNAcombine"))
```
